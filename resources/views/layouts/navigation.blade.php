            ...
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('admin.dashboard') }}">
                        <h1 class="text-white font-bold text-xl tracking-wider">HR MANAGER</h1>
                    </a>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('admin.employees.index')" :active="request()->routeIs('admin.employees.*')" class="text-gray-300 hover:text-white transition duration-150">
                        {{ __('Staff Directory') }}
                    </x-nav-link>
                </div>
            </div>
